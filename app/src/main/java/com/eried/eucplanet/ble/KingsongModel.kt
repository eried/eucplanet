...
enum class KingsongModel(
    ...
    /**
     * 18650/21700 cells in series, derived from [nominalVoltage] at 4.2 V per
     * cell like every other family. It used to be a hand-typed column here,
     * which was a second place for the same fact to go stale.
     */
    val cellsSeries: Int get() = BatteryPercentEstimator.seriesCellsFor(nominalVoltage)
