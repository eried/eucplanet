...
class CompositeWheelAdapterRoutingTest {
    ...
    private val expected = mapOf(
        ...
        WheelFamily.INMOTION_V2 to listOf(
            ...
            // The V6 (2025) and V9 (2024) are Nordic UART wheels too: a real
            // `V6-800679D7` was routed to V1 by its number and had no 0xFFE0
            // service to offer. Unknown numbers default to V2 as well.
            "V6-800679D7", "inmotion-v6", "V9-x", "V7-1",
        ),
