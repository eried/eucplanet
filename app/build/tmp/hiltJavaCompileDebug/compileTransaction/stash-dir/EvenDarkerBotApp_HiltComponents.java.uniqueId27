...
import com.eried.evendarkerbot.di.AppModule;
import com.eried.evendarkerbot.service.WheelService_GeneratedInjector;
...
public final class EvenDarkerBotApp_HiltComponents {
  private EvenDarkerBotApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements EvenDarkerBotApp_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements WheelService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
  ...
  @Subcomponent(
      modules = {
          ...
          FlicViewModel_HiltModules.KeyModule.class,
          HiltWrapper_ActivityRetainedComponentManager_LifecycleModule.class,
          HiltWrapper_SavedStateHandleModule.class,
          MetricDetailViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          FlicViewModel_HiltModules.BindsModule.class,
          HiltWrapper_HiltViewModelFactory_ViewModelModule.class,
          MetricDetailViewModel_HiltModules.BindsModule.class,
